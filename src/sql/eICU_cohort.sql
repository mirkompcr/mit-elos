...
with cohort as (
  ...
  SELECT distinct 
    a.patientunitstayid, a.admissionheight, a.admissionweight, a.unitdischargelocation, 
    a.unitdischargeoffset, a.hospitaldischargeoffset, 
    b.age, b.ethnicity, b.icu_los_hours, b.gender, b.region, 
    b.unittype, b.apache_iv, b.hospitaldischargeyear, b.hospitalid,
    c.sepsis,
...
select * from cohort 
inner join `icu_elos.pivoted_sofa_eicu` as se
on cohort.patientunitstayid = se.patientunitstayid